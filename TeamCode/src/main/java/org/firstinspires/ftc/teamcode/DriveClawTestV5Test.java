...
/*
    ...
    @Disabled
    @TeleOp(name = "New new lift")
    public class DriveClawTestV5Test extends LinearOpMode {
        // variables
        ...
        static final double     MAX_LIFT_HEIGHT         = 1200;
        ...
        public void runOpMode() throws InterruptedException {
            ...
            while (opModeIsActive()) {
                ...
                if (gamepad2.dpad_up && runtime.seconds() > 1.0) {
                    ...
                    liftTarget = 1080; //lift.getCurrentPosition() + (int)(LIFT_HEIGHT * COUNTS_PER_INCH) / 20;   ** 230118 lowered from 850 **
