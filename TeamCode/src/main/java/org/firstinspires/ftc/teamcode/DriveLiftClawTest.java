...
@TeleOp
public class DriveLiftClawTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Fright.setZeroPowerBehavior(DcMoter.ZeroPowerBehavior.BRAKE);
        Bleft.setZeroPowerBehavior(DcMoter.ZeroPowerBehavior.BRAKE);
        Bright.setZeroPowerBehavior(DcMoter.ZeroPowerBehavior.BRAKE); 
